...
function Courses() {
  ...
  return (
    <div className="flex bg-black">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-black w-64 p-5 transform z-10 transition-transform duration-300 ease-in-out ${
      ...
      {/* Main content */}
      <main className="ml-0 md:ml-8 w-full bg-black p-10">
        <header className="flex justify-between items-center mb-10">
          <h1 className="text-xl text-white font-bold">Courses</h1>
          <div className="flex items-center space-x-3">
            <div className="flex items-center">
              <input
                ...
                className="border text-white bg-transparent border-gray-300 rounded-l-full px-4 py-2 h-10 focus:outline-none"
              />
          ...
          {loading ? (
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {filteredCourses.map((course) => (
                <div
                  key={course._id}
                  className="border border-green-400 rounded-lg p-4 shadow-sm"
                >
                  <img
                  ...
                  <Link
                    ...
                    className="bg-green-600 w-full text-white px-4 py-2 rounded-lg hover:bg-blue-900 duration-300"
                  >
                    Buy Now
                  </Link>
                </div>
